...
# heatmap(cor(prostate), Rowv=NA, Colv=NA, symm=T,
#         main='Correlation among inputs' )
```


# 3. Treat lcavol as the outcome, and use all other variables in the data set as predictors. & 4. With the training subset of the prostate data, train a least-squares regression model with all predictors using the lm function.
